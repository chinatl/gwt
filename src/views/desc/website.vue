...
export default {
  ...
  methods: {
    get_forward_info() {
      ...
      this.$post(
        "gwt/website/tbWebsiteForward/getForwardHistory",
        {
    ...
    forward_report() {
      this.$router.push({
        path: "/forward-website/index"
      });
    },
    //签收
    reveive_report() {
      this.$post(
        "gwt/website/tbWebsiteSign/signWebsite",
        {
    ...
    refuse() {
      this.$swal({
        ...
        if (res.value) {
          this.$post(
            "gwt/website/tbWebsiteRefuse/refuseWebsite",
            {
              receId: this.message_data.RECEIVE_ID,
    ...
    get_meeting_data() {
      this.loading = true;
      console.log(this.message_data.RECEIVE_ID);
      this.$post(
        "gwt/website/tbWebsite/getWebsiteTotalInfo",
        {
          receId: this.message_data.RECEIVE_ID
        },
        "json"
